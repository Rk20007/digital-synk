...
export default function HomePage() {
  ...
  const services = [
    ...
    },
    {
      title: "Local SEO",
      description:
        "For small businesses and local brands, Local SEO is a game-changer. People searching 'near me' are ready to buy.",
      icon: MapPin,
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Yes, we create custom strategies for businesses of all sizes, from local startups to global enterprises.",
    },
    {
      question: "Can Digital Synk help with Local SEO?",
      answer:
        "Absolutely. We optimize your Google Business Profile, local listings, and reviews so your business gets found in 'near me' and city-specific searches.",
    },
    {
      ...
      <main>
            ...
            <div className="container mx-auto px-4 md:px-6">
              <div className="max-w-3xl space-y-8">
                <div className="inline-block rounded-full bg-gradient-to-r from-primary/20 to-secondary/20 px-5 py-2.5 text-sm font-semibold text-primary border border-primary/30">
                  🚀 Top Digital Marketing Agency to Boost Your Business Online
                </div>
                ...
                <p className="text-pretty text-lg leading-relaxed text-muted-foreground md:text-xl lg:text-2xl">
                  Digital Synk is the best digital marketing agency to take your business to the next level. We deliver
                  complete digital marketing solutions designed to boost your brand visibility, attract qualified leads,
        ...
        <section className="bg-muted/30 py-20 md:py-32">
          <div className="container mx-auto px-4 md:px-6">
            <div className="mb-16 text-center">
              <h2 className="text-balance text-3xl font-bold md:text-4xl lg:text-5xl">
                Why Digital Synk is the Right Choice for You
              </h2>
            </div>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="mb-16 text-center">
              ...
              <p className="mt-4 text-pretty text-lg text-muted-foreground max-w-2xl mx-auto">
                With experience across multiple industries, we know what works. Whatever your business, we create
                strategies that fuel growth and deliver real results.
              </p>
            </div>
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-primary via-secondary to-primary px-8 py-16 text-center text-primary-foreground shadow-2xl md:px-16 md:py-24">
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-balance text-3xl font-bold md:text-4xl lg:text-5xl mb-4">
                  Ready to Grow with Digital Synk?
                </h2>
                <p className="mx-auto mt-4 max-w-2xl text-pretty text-lg leading-relaxed opacity-95 md:text-xl">
                  Your competitors are online, and your customers are searching. Let us make sure they find you first.
                  Contact us today for a free consultation and let's build your success story together.
                </p>
